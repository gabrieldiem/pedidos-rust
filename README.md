...
| Authorize Payment  | PedidosRust🦀          | PaymentSystem 💲       | `customer_id: u32, amount: f64`                                      | Solicitar la autorización del pago                                                                                  |
| Payment Authorized | PaymentSystem 💲       | PedidosRust🦀          | `customer_id: u32, amount: f64`                                      | Informar que el pago se autorizó exitosamente                                                                       |
| Payment Denied     | PaymentSystem 💲       | PedidosRust🦀          | `customer_id: u32, amount: f64`                                      | Informar que el pago no se pudo autorizar                                                                           |
