...
//     }
//
//     // async fn check_aliveness_of_single_peer(
//     //     _peer_id: u32,
...
//     // }
//     //
//     // async fn check_aliveness(peers: &HashMap<PeerId, Addr<ServerPeer>>, udp_socket: Arc<UdpSocket>, logger: &Logger) -> Result<(), Box<dyn std::error::Error>> {
//     //     let max_rounds_to_determine_dead = 2;
//     //     let number_of_peers = peers.len();
//     //     let mut liveness_marks: HashMap<PeerId, bool> = HashMap::new();
//     //
//     //     for (peer_id, _peer_addr) in peers {
//     //         liveness_marks.insert(*peer_id, true);
//     //     }
//     //
//     //     for _ in 0..max_rounds_to_determine_dead {
//     //         for (peer_id, peer_addr) in peers {
//     //             let res =
//     //                 Self::check_aliveness_of_single_peer(*peer_id, &peer_addr, udp_socket.clone()).await;
//     //
//     //             match res {
//     //                 Ok(true) => {
//     //                     logger.info("ALIVE");
...
// //                     let result = Self::check_aliveness(peers, udp_socket, &logger).await;
// //                     if result.is_err() {
